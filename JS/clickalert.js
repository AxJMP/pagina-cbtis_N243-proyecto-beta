...
$(document).ready(function(){
	...
	$("#e").click(function(evento){ 
	alert("ESTAS POR INGRESAR A LOS PROYECTOS ESCOLARES");
	});
	...
	alert("ESTAS POR INGRESAR A CONTRUYETE, PROGRAMA DE AUTOCONOCMENTO PARA EL ALUMNO");
	});
